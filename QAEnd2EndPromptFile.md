...
```
**Expected Output:**
1. Complete test plan markdown file saved to specs/
2. Organized test scenarios with clear structure
3. Browser exploration screenshots (if needed)
...
2. Exploratory testing results from Step 3 (actual element selectors and UI insights)
...
# STEP 1 - READ USER STORY:
First, read the user story from: user-stories/SCRUM-101-ecommerce-checkout.mdProvide a brief summary of what needs to be tested.
...
Run all automation scripts from `tests/saucedemo-checkout/`.  
...
Execute this complete workflow and provide status update for each step.
